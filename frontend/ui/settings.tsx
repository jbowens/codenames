          ...
          <div className="toggles">
            ...
            <div className="toggle-set" key={toggle.setting}>
              <div className="settings-label">
                {toggle.name} <span className={'toggle-state'}>{this.props.values[toggle.setting] ? 'ON' : 'OFF'}</span>
              </div>
              <div onClick={(e) => this.props.toggle(e, toggle.setting)}
                  className={this.props.values[toggle.setting] ? 'toggle active' : 'toggle inactive'}>
