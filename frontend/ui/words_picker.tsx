...
export class WordsPicker extends React.Component {
  ...
  public render() {
    ...
    let words = this.props.words.trim()
      .split(',')
      .map(w => w.trim())
      .filter(w => w.length > 0);
    ...
    if (this.state.expanded) {
      input = (
        <div>
          <textarea value={this.props.words} onChange={this.onChange.bind(this)} />
        </div>
      );
    }
